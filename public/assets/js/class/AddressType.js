...
const CONFIG = {
    selectors: {
        table: '#address-type-table',
        tableColumn: '#address-type-table-column-dropdown',
        form: '#address_type_form',
        formId: 'address_type_form',
        detailId: 'address_type_id',
        ...
        filterCollapse: 'address-type-filter-collapse',
    ...
    endpoints: {
        tableData: '/address-type/generate-table',
        save: '/address-type/save',
        delete: '/address-type/delete',
        deleteMultiple: '/address-type/delete-multiple',
        fetch: '/address-type/fetch',
    }
};
...
export class AddressType {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'address_types');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { address_type_id: (el) => el.dataset.referenceId },
