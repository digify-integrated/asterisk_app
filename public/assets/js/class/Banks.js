...
const CONFIG = {
    selectors: {
        table: '#bank-table',
        tableColumn: '#bank-table-column-dropdown',
        form: '#bank_form',
        formId: 'bank_form',
        detailId: 'bank_id',
        ...
        filterCollapse: 'bank-filter-collapse',
    ...
    endpoints: {
        tableData: '/bank/generate-table',
        save: '/bank/save',
        delete: '/bank/delete',
        deleteMultiple: '/bank/delete-multiple',
        fetch: '/bank/fetch',
    }
};
...
export class Bank {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'banks');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { bank_id: (el) => el.dataset.referenceId },
