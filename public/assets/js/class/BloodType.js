...
const CONFIG = {
    selectors: {
        table: '#blood-type-table',
        tableColumn: '#blood-type-table-column-dropdown',
        form: '#blood_type_form',
        formId: 'blood_type_form',
        detailId: 'blood_type_id',
        ...
        filterCollapse: 'blood-type-filter-collapse',
    ...
    endpoints: {
        tableData: '/blood-type/generate-table',
        save: '/blood-type/save',
        delete: '/blood-type/delete',
        deleteMultiple: '/blood-type/delete-multiple',
        fetch: '/blood-type/fetch',
    }
};
...
export class BloodType {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'blood_types');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { blood_type_id: (el) => el.dataset.referenceId },
