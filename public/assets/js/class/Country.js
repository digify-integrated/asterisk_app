...
const CONFIG = {
    ...
    endpoints: {
        ...
        deleteMultiple: '/country/delete-multiple',
        fetch: '/country/fetch',
    }
};
...
export class Country {
    ...
    init() {
        ...
        AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'countries');
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { country_id: (el) => el.dataset.referenceId },
