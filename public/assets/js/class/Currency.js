...
const CONFIG = {
    selectors: {
        ...
        tableColumn: '#currency-table-column-dropdown',
        form: '#currency_form',
        formId: 'currency_form',
        detailId: 'currency_id',
        ...
        filterCollapse: 'currency-filter-collapse',
    ...
    endpoints: {
        tableData: '/currency/generate-table',
        save: '/currency/save',
        delete: '/currency/delete',
        deleteMultiple: '/currency/delete-multiple',
...
export class Currency {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'currencies');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { currency_id: (el) => el.dataset.referenceId },
