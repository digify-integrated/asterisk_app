...
const CONFIG = {
    selectors: {
        table: '#gender-table',
        tableColumn: '#gender-table-column-dropdown',
        form: '#gender_form',
        formId: 'gender_form',
        detailId: 'gender_id',
        ...
        filterCollapse: 'gender-filter-collapse',
    ...
    endpoints: {
        tableData: '/gender/generate-table',
        save: '/gender/save',
        delete: '/gender/delete',
        deleteMultiple: '/gender/delete-multiple',
        fetch: '/gender/fetch',
    }
};
...
export class Gender {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'genders');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { gender_id: (el) => el.dataset.referenceId },
