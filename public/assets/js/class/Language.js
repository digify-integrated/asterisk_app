...
const CONFIG = {
    selectors: {
        ...
        tableColumn: '#language-table-column-dropdown',
        form: '#language_form',
        formId: 'language_form',
        detailId: 'language_id',
        ...
        filterCollapse: 'language-filter-collapse',
    ...
    endpoints: {
        tableData: '/language/generate-table',
        save: '/language/save',
        delete: '/language/delete',
        deleteMultiple: '/language/delete-multiple',
...
export class Language {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'languages');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { language_id: (el) => el.dataset.referenceId },
