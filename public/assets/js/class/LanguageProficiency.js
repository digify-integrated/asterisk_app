...
const CONFIG = {
    selectors: {
        table: '#language-proficiency-table',
        tableColumn: '#language-proficiency-table-column-dropdown',
        form: '#language_proficiency_form',
        formId: 'language_proficiency_form',
        detailId: 'language_proficiency_id',
        ...
        filterCollapse: 'language-proficiency-filter-collapse',
    ...
    endpoints: {
        tableData: '/language-proficiency/generate-table',
        save: '/language-proficiency/save',
        delete: '/language-proficiency/delete',
        deleteMultiple: '/language-proficiency/delete-multiple',
        fetch: '/language-proficiency/fetch',
    }
};
...
export class LanguageProficiency {
    ...
    async init() {
        return PageInitializer.run(async () => {
            ...
            AuditLogManager.attachLogNotesClassHandler(CONFIG.selectors.logNotesTrigger, 'language_proficiencies');
        });
    }
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { language_proficiency_id: (el) => el.dataset.referenceId },
    ...
    async handleFetchWorkflow(referenceId) {
        await DetailFetcher.fetch({
            ...
            onSuccess: async (response) => {
                ...
                const targetFields = {
                    'language_proficiency_id': referenceId,
                    'name': data.name,
