...
const CONFIG = {
    selectors: {
        ...
        tableColumn: '#marital-status-table-column-dropdown',
        form: '#marital_status_form',
        formId: 'marital_status_form',
        detailId: 'marital_status_id',
        ...
        filterCollapse: 'marital-status-filter-collapse',
    ...
    endpoints: {
        tableData: '/marital-status/generate-table',
        save: '/marital-status/save',
        delete: '/marital-status/delete',
        deleteMultiple: '/marital-status/delete-multiple',
        fetch: '/marital-status/fetch',
    }
};
...
export class MaritalStatus {
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { marital_status_id: (el) => el.dataset.referenceId },
