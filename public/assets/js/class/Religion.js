...
const CONFIG = {
    selectors: {
        table: '#religion-table',
        tableColumn: '#religion-table-column-dropdown',
        form: '#religion_form',
        formId: 'religion_form',
        detailId: 'religion_id',
        ...
        filterCollapse: 'religion-filter-collapse',
    ...
    endpoints: {
        tableData: '/religion/generate-table',
        save: '/religion/save',
        delete: '/religion/delete',
        deleteMultiple: '/religion/delete-multiple',
        fetch: '/religion/fetch',
    }
};
...
export class Religion {
    ...
    initDelete() {
        initConfirmAction({
            ...
            method: 'DELETE',
            payload: { religion_id: (el) => el.dataset.referenceId },
