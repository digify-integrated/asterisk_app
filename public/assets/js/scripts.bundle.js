    ...
    var e = !1,
        ...
        o = function (e) {
            ...
            const n = Object.assign(
                {},
                { container: e, slideBy: "page", autoplay: !0, center: !0, autoplayButtonOutput: !1 },
                t
            );
        ...
        init: function () {
            ...
            !(function () {
                ...
                [].slice.call(document.querySelectorAll(".toast")).map(function (e) {
                    if ("1" !== e.getAttribute("data-kt-initialized"))
                        return e.setAttribute("data-kt-initialized", "1"), new bootstrap.Toast(e, {});
                }),
                (function () {
                ...
                "undefined" != typeof jQuery &&
                    void 0 !== $.fn.select2 &&
                    [].slice
                        .call(document.querySelectorAll('[data-control="select2"], [data-kt-select2="true"]'))
                        .map(function (e) {
                            if ("1" !== e.getAttribute("data-kt-initialized")) {
                                ...
                                if (
                                    ...
                                    $(e).select2(t),
                                    e.hasAttribute("data-dropdown-parent") && e.hasAttribute("multiple"))
                                ) {
                                            ...
                                            i &&
                                                ...
                                                i.on("kt.menu.dropdown.hide", function (t) {
                                                    if ("1" === e.getAttribute("data-multiple-unselect"))
                                                        return e.removeAttribute("data-multiple-unselect"), !1;
                                                }));
                                    }
                                }
                                e.setAttribute("data-kt-initialized", "1");
                ...
                "undefined" != typeof countUp &&
                    ...
                    [].slice
                        .call(document.querySelectorAll('[data-kt-countup-tabs="true"][data-bs-toggle="tab"]'))
                        .map(function (e) {
                            "1" !== e.getAttribute("data-kt-initialized") &&
                                (e.addEventListener("shown.bs.tab", r), e.setAttribute("data-kt-initialized", "1"));
                        }),
                    (t = !0)),
                ...
                (function () {
                    ...
                    (e || 0 !== e.length) &&
                        e.forEach(function (e) {
                            "1" !== e.getAttribute("data-kt-initialized") &&
                                (o(e), KTUtil.data(e).set("tns", tns), e.setAttribute("data-kt-initialized", "1"));
                        });
                })(),
                (e = !0);
        },
            ...
            (n.block = function () {
                !(function () {
                    if (!1 !== KTEventHandler.trigger(n.element, "kt.blockui.block", n)) {
                        ...
                        n.options.zIndex > 0
                            ? (r = n.options.zIndex)
                            : "auto" != KTUtil.css(n.element, "z-index") && (r = KTUtil.css(n.element, "z-index")),
                            n.element.classList.add("blockui"),
                            ("absolute" !== t && "relative" !== t && "fixed" !== t) ||
                                (KTUtil.css(n.element, "position", "relative"), (n.positionChanged = !0)),
                            "hidden" === n.options.overflow &&
                                "visible" === i &&
                                (KTUtil.css(n.element, "overflow", "hidden"), (n.overflowChanged = !0)),
...
var KTCookie = {
    ...
    set: function (e, t, n) {
        null == n && (n = {}),
            (n = Object.assign({}, { path: "/" }, n)).expires instanceof Date && (n.expires = n.expires.toUTCString());
        ...
        var i = { min: null, max: null, step: 1, currency: !1, decimals: 0, prefix: "", suffix: "" },
            ...
            d = function (e) {
                return (
                    ...
                    n.options.currency && (e = e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")),
            ...
            var i = { overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay" },
                ...
                a = function () {
                    !1 !== KTEventHandler.trigger(n.element, "kt.drawer.toggle", n) &&
                        !1 !== m("activate") &&
                        (!0 === n.shown ? l() : s(), KTEventHandler.trigger(n.element, "kt.drawer.toggled", n));
                },
                l = function () {
                ...
                u = function () {
                    ...
                    "on" === String(document.body.getAttribute("data-kt-drawer-" + n.name + "-"))
                        ? (n.shown = !0)
                        : (n.shown = !1),
                        !0 === m("activate")
        ...
        (t.show = function () {
            return (function () {
                if (!1 !== KTEventHandler.trigger(t.element, "kt.feedback.show", t))
                    return (
                        "popup" === t.options.type && o(), KTEventHandler.trigger(t.element, "kt.feedback.shown", t), t
                    );
            })();
        }),
        (t.hide = function () {
        ...
        if (null != e) {
            var i = { dropdown: { hoverTimeout: 200, zindex: 107 }, accordion: { slideSpeed: 250, expand: !1 } },
                ...
                m = function (e) {
                    ...
                    return (
                        null !== t &&
                        ("dropdown" === v(e)
                            ? !0 === KTUtil.hasClass(t, "show") && !0 === t.hasAttribute("data-popper-placement")
                ...
                E = function (e) {
                    !0 === KTUtil.data(e).has("popper") &&
                        (KTUtil.data(e).get("popper").destroy(), KTUtil.data(e).remove("popper"));
                },
                S = function (e) {
                    var t = L(e, "placement");
                    t || (t = "right");
            ...
            !0 === KTUtil.data(e).has("menu") ? (n = KTUtil.data(e).get("menu")) : r(),
                ...
                (n.link = function (e, t) {
                    return (function (e) {
                        !0 !== n.disabled &&
                            !1 !== KTEventHandler.trigger(n.element, "kt.menu.link.click", e) &&
                            (KTMenu.hideDropdowns(), KTEventHandler.trigger(n.element, "kt.menu.link.clicked", e));
                    })(e);
                }),
                ...
                (n.mouseover = function (e, t) {
                    return (function (e) {
                        ...
                        !0 !== n.disabled &&
                            null !== t &&
                            "hover" === L(t, "trigger") &&
                            ("1" === KTUtil.data(t).get("hover") &&
                                (clearTimeout(KTUtil.data(t).get("timeout")),
                ...
                (n.mouseout = function (e, t) {
                    return (function (e) {
                        var t = T(e);
                        if (!0 !== n.disabled && null !== t && "hover" === L(t, "trigger")) {
...
(KTMenu.getInstance = function (e) {
        ...
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++) {
                ...
                o &&
                    ...
                    (e
                        ? !1 === o.getItemSubElement(r).contains(e) && !1 === r.contains(e) && r !== e && o.hide(r)
                        : o.hide(r));
            }
    }),
            ...
            if (r && r.length > 0)
                for (var o = 0, a = r.length; o < a; o++)
                    if (((t = r[o]), (i = KTMenu.getInstance(t)) && "dropdown" === i.getItemSubType(t))) {
                        if ((i.getElement(), (n = i.getItemSubElement(t)), t === e.target || t.contains(e.target)))
                            continue;
    ...
    (KTMenu.init = function () {
        KTMenu.createInstances(),
            !1 === KTMenuHandlersInitialized && (KTMenu.initHandlers(), (KTMenuHandlersInitialized = !0));
    }),
...
(KTScroll.getInstance = function (e) {
    ...
    (KTScroll.init = function () {
        KTScroll.createInstances(),
            !1 === KTScrollHandlersInitialized && (KTScroll.handleResize(), (KTScrollHandlersInitialized = !0));
    }),
            ...
            s = function (e) {
                if (!0 === n.element.hasAttribute("data-kt-scrolltop-" + e)) {
                    var t = n.element.getAttribute("data-kt-scrolltop-" + e),
                        i = KTUtil.getResponsiveValue(t);
                    return (
                        null !== i && "true" === String(i) ? (i = !0) : null !== i && "false" === String(i) && (i = !1),
                        i
                    );
                }
                var r = KTUtil.snakeToCamel(e);
        ...
        var i = { minLength: 2, keypress: !0, enter: !0, layout: "menu", responsive: null, showOnFocus: !0 },
                        ...
                        (n.toggleElement &&
                            ...
                            n.menuObject.on("kt.menu.dropdown.show", function (e) {
                                KTUtil.visible(n.toggleElement) &&
                                    (n.toggleElement.classList.add("active"), n.toggleElement.classList.add("show"));
                            }),
            ...
            a = function () {
                n.element.classList.add("focus"),
                    (!0 === g("show-on-focus") || n.inputElement.value.length >= n.minLength) && f();
            },
            l = function () {
            ...
            u = function () {
                g("min-length") &&
                    (n.inputElement.value.length >= n.minLength ? d() : 0 === n.inputElement.value.length && c());
            },
            d = function () {
                !1 === n.processing &&
                ...
                if ("menu" === n.layout) {
                    ...
                    "on" === e && !1 === n.contentElement.contains(n.formElement)
                        ...
                        : "off" === e &&
                          ...
                          (n.element.prepend(n.formElement), n.formElement.classList.add("d-none"));
                }
            },
            f = function () {
            ...
            g = function (e) {
                ...
                var r = KTUtil.snakeToCamel(e);
                return null != n.options[r] ? KTUtil.getResponsiveValue(n.options[r]) : null;
            },
            v = function (e) {
...
(KTSticky.getInstance = function (e) {
    ...
    (KTSticky.init = function () {
        KTSticky.createInstances(),
            !1 === KTStickyHandlersInitialized && (KTSticky.handleResize(), (KTStickyHandlersInitialized = !0));
    }),
...
(KTSwapper.getInstance = function (e) {
    ...
    (KTSwapper.init = function () {
        KTSwapper.createInstances(),
            !1 === KTSwapperHandlersInitialized && (KTSwapper.handleResize(), (KTSwapperHandlersInitialized = !0));
    }),
        ...
        var i = { saveState: !0 },
            r = function () {
                (n.options = KTUtil.deepExtend({}, i, t)),
                    ...
                    (n.element = e),
                    (n.target = document.querySelector(n.element.getAttribute("data-kt-toggle-target"))
    ...
    return {
        ...
        getHighestZindex: function (e) {
            for (var t, n; e && e !== document; ) {
                if (
                    ("absolute" === (t = KTUtil.css(e, "position")) || "relative" === t || "fixed" === t) &&
                ...
                set: function (t, n) {
                    e &&
                        (void 0 === e.customDataTag &&
                            (window.KTUtilElementDataStoreID++, (e.customDataTag = window.KTUtilElementDataStoreID)),
        ...
        outerHeight: function (e, t) {
            var n,
                i = e.offsetHeight;
            return void 0 !== t && !0 === t
                ? ((n = getComputedStyle(e)), (i += parseInt(n.marginTop) + parseInt(n.marginBottom)))
                : i;
        },
        visible: function (e) {
            ...
            if (!(!e || ("up" == t && !1 === KTUtil.visible(e)) || ("down" == t && !0 === KTUtil.visible(e)))) {
                ...
                KTUtil.css(e, "padding-top") &&
                    ...
                    KTUtil.css(e, "padding-bottom") &&
                        ...
                        KTUtil.data(e).set("slide-padding-bottom", KTUtil.css(e, "padding-bottom")),
        ...
        one: function (e, t, n) {
            e.addEventListener(t, function t(i) {
                return (
                    i.target && i.target.removeEventListener && i.target.removeEventListener(i.type, t),
        ...
        numberString: function (e) {
            for (
                var t = (e += "").split("."), n = t[0], i = t.length > 1 ? "." + t[1] : "", r = /(\d+)(\d{3})/;
                r.test(n);
        ...
        getResponsiveValue: function (e, t) {
            ...
            if ("object" == typeof (e = KTUtil.parseJson(e))) {
                var r,
                    ...
                    a = -1;
                for (var l in e)
                    (o = "default" === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <= n &&
                        o > a &&
                        ((r = l), (a = o));
                i = r ? e[r] : e;
            } else i = e;
        ...
        getConditionalValue: function (e) {
            ...
            return (
                null !== t && void 0 !== t.match && (t = KTUtil.getSelectorMatchValue(t)),
        ...
        onDOMContentLoaded: function (e) {
            "loading" === document.readyState
                ? (document.addEventListener("DOMContentLoaded", e), document.addEventListener("livewire:navigated", e))
                : e();
        },
        inIframe: function () {
            try {
