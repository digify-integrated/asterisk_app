...
@section('content')
    <form class="form w-100" id="login_form" method="POST" action="#" novalidate>
        ...
        <div class="fv-row mb-4">
            ...
            <input type="email" name="email" id="email" class="form-control form-control-sm bg-transparent" autocomplete="off" placeholder="you@company.com"/>
        </div>
        ...
        <div class="d-grid mb-6">
            <button type="submit" id="signin" class="btn btn-primary btn-sm fw-semibold">
                Sign in
            </button>
        </div>
    </form>
