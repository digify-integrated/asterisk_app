        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
           <div class="d-flex flex-lg-row-fluid w-lg-60 position-relative overflow-hidden hero-section">
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-40 bg-body">
                <div class="d-flex flex-center flex-column flex-column-fluid px-10 px-lg-15 py-12">
                    <div class="w-100 mw-550px">
                        ...
                        <div class="text-center">
                            <span class="text-gray-500 fs-7">© {{ date('Y') }} Asterisk Solutions</span>
                        </div>
                    </div>
                </div>
            </div>
