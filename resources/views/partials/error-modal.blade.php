<div id="system-error-modal"
     class="modal fade"
     tabindex="-1"
     aria-labelledby="system-error-modal-label"
     aria-hidden="true">
            ...
            <div class="modal-header border-0 px-8 pt-8 pb-5">
                ...
                <div class="d-flex align-items-start gap-4">
                    ...
                    <div>
                        ...
                        <h2 id="system-error-modal-label"
                            class="fw-bold fs-3 text-gray-900 mb-2">
            ...
            <div class="modal-body px-8 py-7">
                ...
                <div class="mb-6">
                    ...
                    <div class="border rounded bg-light p-5">
                        ...
                        <pre id="error-dialog"
                             class="mb-0 fs-8 text-gray-800"
                             style="max-height:400px;overflow:auto;white-space:pre-wrap;font-family:var(--bs-font-monospace);"></pre>
