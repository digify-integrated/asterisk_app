<button type="button" class="btn btn-light-dark btn-sm btn-flex align-items-center table-export position-relative" data-bs-toggle="modal" data-bs-target="#{{ $modalId }}">
    <i class="ki-outline ki-filter fs-5"></i>
    <span>Filter</span>
    <span data-filter-badge="{{ $modalId }}" class="badge badge-circle badge-sm badge-primary ms-2 d-none">0</span>
</button>
        ...
        <div class="modal-content border-0 rounded-4">
            ...
            <form class="m-0">
                ...
                <div class="modal-footer border-0 px-8 py-6">
                    ...
                    <button type="button" id="reset-filter" class="btn btn-warning btn-sm">Reset</button>
                    <button type="button" id="apply-filter" class="btn btn-success btn-sm">Apply</button>
                </div>
            </form>
        </div>
    </div>
