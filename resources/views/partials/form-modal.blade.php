        ...
        <div class="modal-content border-0 rounded-4">
            <div class="modal-header border-0 px-8 pt-8 pb-6">
                <div class="d-flex align-items-start gap-4">
                    ...
                    <div>
                        <h2 class="fw-bold fs-3 text-gray-900 mb-1" id="modal-title-{{ $formId }}">{{ $formTitle }}</h2>
                        <p class="text-muted fs-7 mb-0">Complete the required information below before saving.</p>
                    </div>
                </div>
            ...
            <div class="modal-footer border-0 px-8 py-6">
                ...
                <button type="submit" form="{{ $formId }}" id="submit-data" class="btn btn-primary btn-sm">
                    Save Changes
                </button>
            </div>
        </div>
